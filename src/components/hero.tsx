...
<section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-black font-primary">
  ...
  <div className="relative z-10 w-full px-6 pt-32 pb-20 flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-10 lg:gap-24 container mx-auto">
    ...
    <div className="text-white space-y-4 text-center lg:text-left flex-1 max-w-2xl ml-[2%]">
      <motion.div 
        ...
        className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-yellow-500 text-[10px] tracking-[0.4em] uppercase font-semibold"
      >
      ...
      >
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-black uppercase tracking-wider leading-[1.1] lg:leading-[0.9]">
          IRISH <br />
          <span className="text-yellow-500 font-extralight tracking-wide">PLATINUM</span>
        </h1>
        
        <p className="mt-4 text-gray-400 text-[10px] md:text-sm lg:text-base tracking-[0.2em] uppercase font-light leading-relaxed">
...
<div className="lg:hidden absolute bottom-12 w-full flex flex-col items-center gap-3 z-20 pointer-events-none">
  <motion.div 
  ...
  >
    <p className="text-yellow-500/80 text-[8px] uppercase tracking-[0.6em] font-medium mb-2">
